#------------------------------------------------------------------------------#
#   Title: Development experiment 17
#  Author: B. Saul
#    Date: 2017-02-25
...
library(doMC)
registerDoMC(4)
source('development/experiments/ex17/ex17_funs.R')
source('development/experiments/ex17/ex17_settings.R')
nsims <- 50
which_scenarios <- 5
...
save(estimates, scenarios, oracle, results, nsims, margs,
     file = 'development/experiments/ex17/ex17_results.rda')
