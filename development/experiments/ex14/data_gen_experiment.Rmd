...
\[
A_{ij} \sim Bern(plogis(\gamma_0 + \gamma_1 |Z_{1ij}| + \gamma_2 Z_{2ij} + \gamma_3 |Z_{1ij}| Z_{2ij} + b_i))
\]
...
\[
Y_{ij} \sim N(\beta_0 + \beta_1 A_{ij} + \beta_2 f(A_i) + \beta_3 Z_{1ij} + \beta_4 Z_{2ij} + \beta_4 |Z_{1ij}| Z_{2ij} , 1)
\]
