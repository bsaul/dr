\documentclass[oupdraft]{biostatistics}
%\documentclass[12pt]{article}
\usepackage[colorlinks=true, urlcolor=cyan, linkcolor=red, citecolor=red]{hyperref}
...
\includegraphics{ex27_y_0_5.pdf}
\end{figure}

\begin{figure}[h!]
\centering
\label{fig:simulation_results_1}
\includegraphics{ex27_y_1_5.pdf}
\end{figure}
