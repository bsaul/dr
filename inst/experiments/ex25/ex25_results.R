...
load(file = 'inst/experiments/ex25/ex25_results.rda')
...
ggsave(filename = paste0('inst/experiments/ex25/figures/', 'y_1_5', '.pdf'),
       plot = y_1_5,
       width = 8.5, height = 5)
...
ggsave(filename = paste0('inst/experiments/ex25/figures/', 'y_0_5', '.pdf'),
       plot = y_0_5,
       width = 8.5, height = 5)
...
lapply(c(9), function(sid){
  ...
  ggsave(filename = paste0('inst/experiments/ex25/figures/scn', sid, '.pdf'),
         plot = p,
         width = 8.5, height = 4)
})
