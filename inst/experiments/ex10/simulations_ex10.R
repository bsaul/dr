...
sims <- split(sims_200x_m300_n20_s198_ex10, sims_200x_m300_n20_s198_ex10$simID)
library(doMC)
registerDoMC(2)
...
save(results, estimates, oracle, file = paste0('development/experiments/ex10/simresults_', Sys.Date(), '.rda'))
