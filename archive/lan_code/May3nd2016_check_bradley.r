...
#		A_inter=A_inter_sum*J.vec
		...
		setwd('/Users/Lan/Sync/Lan/study/statistics/biostatistics/research/my_paper/hajek')
		load('ex04_test_data.rda')
		bradley_data=ex04_test_data
		n=n_i*m
		Z1=bradley_data$Z1
		Z2=bradley_data$Z2
		Z3=bradley_data$Z3
...
#			A_inter=A_inter_sum
		...
		epsilon=bradley_data$e
		# epsilon=rnorm(n,0,1)
		y=mu.true+epsilon
		print(cbind(y,bradley_data$Y)[1:10,])
